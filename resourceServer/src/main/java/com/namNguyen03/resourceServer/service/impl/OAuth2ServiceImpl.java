...
import com.namNguyen03.resourceServer.service.OAuth2Service;
@Service
public class OAuth2ServiceImpl implements OAuth2Service {
	...
	@Override
	public AccessToken getAccessToken(String clientId, String clientSecret, String redirectUri, String code,
			String state) {
